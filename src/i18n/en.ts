export const en = {
  ...
  contact: {
    title: 'Contact',
    subtitle: 'For bookings and questions.',
    emailLabel: 'Email',
    whatsappLabel: 'WhatsApp',
    locationLabel: 'Based in',
    locationValue: 'Bangalore, India — online consultations via Zoom / Google Meet',
  ...
  share: {
    title: 'QR codes',
    subtitle: 'Book a consultation on WhatsApp, or open the website.',
    download: 'Download QR',
    downloadWa: 'Save WhatsApp QR',
    downloadSite: 'Save website QR',
    linkLabel: 'Website',
    tip: '',
    ...
    bookQrLead: '',
    bookQrTip: '',
    bookQrAlt: 'WhatsApp QR code — Find My Nakshatra',
    bookQrCompact: 'Book a consultation',
    websiteQrTitle: 'Website',
    websiteQrLead: '',
    whatsappQrPrefill: 'Namaste, I want to book a consultation with Find My Nakshatra.',
  },

  contactPrivacyNote: 'Please use WhatsApp or email to reach us.',

  ctaBand: {
    title: 'Book a consultation',
    sub: 'Available in English and Tamil.',
